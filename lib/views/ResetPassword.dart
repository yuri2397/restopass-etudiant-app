...
class _ResetPasswordState extends State<ResetPassword> {
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            errorText: _emailError
                                ? "Veuillez saissir votre mot de passe"
                                : null,
                            prefixIcon: Icon(
                              Icons.email,
                              color: kPrimaryColor,
  ...
  void _afterResponse(ApiResponse apiResponse) async {
    if (apiResponse.error == false) {
      ...
      _hasErrors = true;
      _message =
          "Oups, nous rencontrons quelques problèmes. Veuillez réessayer plus tard.";
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                ...
                Text(
                    'Un lien de réinitialisation de mot de passe vous a été envoyé par mail. Merci de verifier.'),
              ],
            ),
          ),
          actions: <Widget>[
